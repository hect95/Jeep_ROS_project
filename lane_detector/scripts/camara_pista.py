...
puntos= np.array([[0, 260], [0, 360], [640, 360], [640, 260]])#sin recorte
...
def image2_callback (msg):
	...
	final = cv2.dilate(final, kernel_r, iterations = 1)
	...
	img_ , steering_angle = draw_lanes(frame, curves[0], curves[1])
